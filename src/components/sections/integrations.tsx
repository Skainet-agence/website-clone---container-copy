...
const IntegrationCard = ({ name, icon: Icon, color, index }: Integration & { index: number }) => (
  <div 
    className="bg-[#2a2f5a] text-center p-6 md:p-8 rounded-xl transition-all duration-300 hover:scale-110 hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/20 hover:bg-[#323762] border border-white/10 hover:border-white/20 group animate-in fade-in zoom-in duration-700"
...
export default function Integrations() {
  return (
    <section id="integrations" className="relative py-13 sm:py-19 lg:py-26 bg-gradient-radial from-[#1A1B3F] to-[#0A0B1E]">
