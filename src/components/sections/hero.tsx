...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-background-primary overflow-hidden pt-12 pb-20">
      {/* DotGrid Background */}
      ...
      <div className="container mx-auto px-4 relative z-10 text-center py-16 md:py-26 max-w-6xl">
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-[4.5rem] font-black text-white leading-[1.1] mb-8 md:mb-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
          Propulsez votre entreprise avec{" "}
          <span className="text-[#0084FF] block mt-2">L'intelligence artificielle</span>{" "}
          vers de nouveaux sommets
        </h1>
        
        <div className="space-y-3 animate-in fade-in slide-in-from-bottom-4 duration-700 mb-10" style={{ animationDelay: '200ms' }}>
